...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    ...
    {
        /// <summary>
        /// Gets Child Value from a specified path
        /// Will return a snapshot of the Value of the Child in the callback output
        /// </summary>
        /// <param name="path"> Database path </param>
        /// <param name="child"> Database path </param>
        ...
        public static extern void GetChildList(string path, string child, string objectName, string callback, string fallback);
        ...
        /// <param name="fallback"> Name of the method to call when the operation was unsuccessful. Method must have signature: void Method(string output). Will return a serialized FirebaseError object </param>
        [DllImport("__Internal")]
        public static extern void GetChildValue(string path, string child, string objectName, string callback, string fallback);
